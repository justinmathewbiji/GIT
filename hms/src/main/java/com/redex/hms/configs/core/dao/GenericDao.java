...
package com.redex.hms.configs.core.dao;
...
//    public <T> ArrayList<T> readListByCriterionsAndProjections(Criterion[] criterions, ProjectionList[] projections) throws Exception;
    ...
    public List<T> readListByQuery(String query, Map<String, Object> queryParams) throws Exception;
    
     public List<T> readBeanListByQuery(String query, Map<String, Object> queryParams,Class resultClass) throws Exception;
