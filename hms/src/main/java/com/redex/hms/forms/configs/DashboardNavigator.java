...
public class DashboardNavigator extends Navigator {
	...
	/*private static final RedexViewItem ERROR_VIEW = RedexViewItem.DASHBOARD;*/
	private static final RedexViewItem ERROR_VIEW =DashboardUI.getRedexViewItemMap().get("dashboard");
	...
	private void initViewChangeListener() {
		addViewChangeListener(new ViewChangeListener() {
			...
			public void afterViewChange(final ViewChangeEvent event) {
				/*RedexViewItem view = RedexViewItem.getByViewName(event
						.getViewName());*/
				RedexViewItem view =DashboardUI.getRedexViewItemMap().get(event
						.getViewName());
	...
	private void initViewProviders() {
		for (Entry<String, RedexViewItem> entry : DashboardUI.getRedexViewItemMap().entrySet()) {
			final RedexViewItem viewType=entry.getValue();
			addView(entry.getKey(), viewType.getViewClass());
		...
		setErrorProvider(new ViewProvider() {
			...
			@Override
			public View getView(final String viewName) {
				return ERROR_VIEW.getViewClass();
