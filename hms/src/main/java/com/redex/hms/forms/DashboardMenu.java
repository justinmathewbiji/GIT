...
import com.redex.hms.forms.component.ProfilePreferencesWindow;
import com.redex.hms.forms.domain.User;
import com.redex.hms.forms.event.DashboardEvent.NotificationsCountUpdatedEvent;
import com.redex.hms.forms.event.DashboardEvent.PostViewChangeEvent;
import com.redex.hms.forms.event.DashboardEvent.ProfileUpdatedEvent;
import com.redex.hms.forms.event.DashboardEvent.ReportsCountUpdatedEvent;
...
public final class DashboardMenu extends CustomComponent {
	...
	private Component buildTitle() {
		Label logo = new Label("Redex <strong>HMS</strong>",
				ContentMode.HTML);
	...
	private Component buildMenuItems() {
		...
		for(Entry<String, RedexViewItem> entry: DashboardUI.getRedexViewItemMap().entrySet()){
			RedexViewItem view=entry.getValue();
			...
			/*if (view == RedexViewItem.DASHBOARD) {
	...
	public final class ValoMenuItemButton extends Button {
		...
		private final RedexViewItem view;

		public ValoMenuItemButton(final RedexViewItem view) {
			this.view = view;
